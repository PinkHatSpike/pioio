...
public class PIOIOLooperReflection extends PIOIOLooper {
    private static final String TAG = "PIOIOLooperReflection";
    PApplet _applet;
    Method _ioioSetup;
    Method _ioioLoop;

    public PIOIOLooperReflection(PApplet applet) {
        super();
    ...
    protected IOIOLooper createIOIOLooper() {
        return new PIOIOLooperReflection(_applet);
    }
}